...
class CurlWrapper
{
	 ...
	 */
	public function httpAuthentication($p_username, $p_password)
	{
		$this->setProperties(CURLOPT_USERPWD, "$p_username:$p_password");
	...
	{
		$this->setProperties(CURLOPT_HTTPHEADER, array("$p_name: $p_value"));
	}
	 ...
	 * Set properties
	 * 
	 * @param String $p_properties
	 * @param Mixed  $p_values
	 */
	private function setProperties($p_properties, $p_values)
	{
		curl_setopt($this->curlHandle, $p_properties, $p_values);
	}
