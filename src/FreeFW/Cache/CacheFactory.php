...
class CacheFactory
{
        ...
        switch ($type) {
            ...
            case self::MEMCACHED:
                if (! static::isMemcachedAvailable() || ! $arg0 instanceof \Memcached) {
                    throw new CacheException('Memcached cache not available: not installed or argument not a Redis instance');
                }
    ...
    /**
     * Discover cache : APCU -> Redis -> File
     *
     * @throws CacheException
     *
     * @return CacheItemPoolInterface
     ...
     * @return boolean
     */
    private static function isFilesWritable($p_dir)
    {
        return is_writable($p_dir);
    }
