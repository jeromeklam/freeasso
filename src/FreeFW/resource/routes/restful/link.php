 ...
 */
$routes_link = [
    'free_f_w.link.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Link',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Link',
        FFCSTRT::ROUTE_URL        => '/v1/core/link/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Link',
