 ...
 */
$routes_country = [
    'free_f_w.country.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Country',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Country',
        FFCSTRT::ROUTE_URL        => '/v1/core/country/autocomplete/:search',
    ...
    'free_f_w.country.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Country',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Country',
        FFCSTRT::ROUTE_URL        => '/v1/core/country/:cnty_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Country',
