 ...
 */
$routes_file = [
    'free_f_w.file.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/File',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::File',
        FFCSTRT::ROUTE_URL        => '/v1/core/file/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::File',
