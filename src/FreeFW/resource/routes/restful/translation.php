 ...
 */
$routes_translation = [
    'free_f_w.translation.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Translation',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Translation',
        FFCSTRT::ROUTE_URL        => '/v1/core/translation/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Translation',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeFW::Model::Translation',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_f_w.translation.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Translation',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Translation',
        FFCSTRT::ROUTE_URL        => '/v1/core/translation',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Translation',
    ...
    'free_f_w.translation.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Translation',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Translation',
        FFCSTRT::ROUTE_URL        => '/v1/core/translation/:tr_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Translation',
    ...
    'free_f_w.translation.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Translation',
    ...
    'free_f_w.translation.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Translation',
    ...
    'free_f_w.translation.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Translation',
