 ...
 */
$routes_message = [
    'free_f_w.message.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Message',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Message',
        FFCSTRT::ROUTE_URL        => '/v1/core/message/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Message',
    ...
    'free_f_w.message.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Message',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Message',
        FFCSTRT::ROUTE_URL        => '/v1/core/message/:msg_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Message',
