 ...
 */
$routes_version = [
    'free_f_w.version.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Version',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Version',
        FFCSTRT::ROUTE_URL        => '/v1/core/version/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Version',
    ...
    'free_f_w.version.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Version',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Version',
        FFCSTRT::ROUTE_URL        => '/v1/core/version/:vers_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Version',
