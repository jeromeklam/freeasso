...
/**
 * Routes for TaxonomyLang
 *
 * @author jeromeklam
 */
$routes_taxonomy_lang = [
    'free_f_w.taxonomy_lang.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/TaxonomyLang',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::TaxonomyLang',
        FFCSTRT::ROUTE_URL        => '/v1/core/taxonomy_lang/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::TaxonomyLang',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeFW::Model::TaxonomyLang',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_f_w.taxonomy_lang.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/TaxonomyLang',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::TaxonomyLang',
        FFCSTRT::ROUTE_URL        => '/v1/core/taxonomy_lang',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::TaxonomyLang',
    ...
    'free_f_w.taxonomy_lang.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/TaxonomyLang',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::TaxonomyLang',
        FFCSTRT::ROUTE_URL        => '/v1/core/taxonomy_lang/:txl_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::TaxonomyLang',
    ...
    'free_f_w.taxonomy_lang.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/TaxonomyLang',
    ...
    'free_f_w.taxonomy_lang.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/TaxonomyLang',
    ...
    'free_f_w.taxonomy_lang.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/TaxonomyLang',
