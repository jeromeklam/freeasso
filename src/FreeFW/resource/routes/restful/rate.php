 ...
 */
$routes_rate = [
    'free_f_w.rate.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Rate',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Rate',
        FFCSTRT::ROUTE_URL        => '/v1/core/rate/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Rate',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeFW::Model::Rate',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_f_w.rate.getlast' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Rate',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne les taux.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Rate',
        FFCSTRT::ROUTE_URL        => '/v1/core/rate/latest',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Rate',
        FFCSTRT::ROUTE_FUNCTION   => 'getLatest',
        FFCSTRT::ROUTE_AUTH       => FFCSTRT::AUTH_IN,
        FFCSTRT::ROUTE_MIDDLEWARE => [
