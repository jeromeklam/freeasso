 ...
 */
$routes_cache = [
    'free_f_w.cache.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Cache',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Cache',
        FFCSTRT::ROUTE_URL        => '/v1/core/cache/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Cache',
    ...
    'free_f_w.cache.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Cache',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Cache',
        FFCSTRT::ROUTE_URL        => '/v1/core/cache/:tab_name',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Cache',
