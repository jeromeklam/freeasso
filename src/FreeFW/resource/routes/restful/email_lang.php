...
/**
 * Routes for EmailLang
 *
 * @author jeromeklam
 */
$routes_email_lang = [
    'free_f_w.email_lang.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/EmailLang',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::EmailLang',
        FFCSTRT::ROUTE_URL        => '/v1/core/email_lang/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::EmailLang',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeFW::Model::EmailLang',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_f_w.email_lang.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/EmailLang',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::EmailLang',
        FFCSTRT::ROUTE_URL        => '/v1/core/email_lang',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::EmailLang',
    ...
    'free_f_w.email_lang.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/EmailLang',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::EmailLang',
        FFCSTRT::ROUTE_URL        => '/v1/core/email_lang/:emaill_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::EmailLang',
