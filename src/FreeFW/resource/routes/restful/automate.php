 ...
 */
$routes_automate = [
    'free_f_w.automate.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Automate',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Automate',
        FFCSTRT::ROUTE_URL        => '/v1/core/automate/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Automate',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeFW::Model::Automate',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_f_w.automate.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Automate',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Automate',
        FFCSTRT::ROUTE_URL        => '/v1/core/automate',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Automate',
    ...
    'free_f_w.automate.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeFW/Core/Automate',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeFW::Model::Automate',
        FFCSTRT::ROUTE_URL        => '/v1/core/automate/:auto_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeFW::Controller::Automate',
