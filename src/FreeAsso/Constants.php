...
class Constants
{
    ...
    const ERROR_MOVEMENT_FROM_MISSING         = 5220008;
    const ERROR_MOVEMENT_TO_MISSING           = 5220009;
    const ERROR_CERTIFICATE_GENERATE          = 5220010;
    ...
    const ERROR_CERTIFICATE_EXISTS            = 6690018;
