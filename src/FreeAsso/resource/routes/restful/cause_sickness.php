...
$causeSicknessRoutes = [
    'free_asso.cause_sickness.autocomplete' => [
        ...
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseSickness',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_sickness/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseSickness',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::CauseSickness',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.cause_sickness.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseSickness',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseSickness',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_sickness',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseSickness',
    ...
    'free_asso.cause_sickness.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseSickness',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseSickness',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_sickness/:caus_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseSickness',
    ...
    'free_asso.cause_sickness.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseSickness',
    ...
    'free_asso.cause_sickness.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseSickness',
    ...
    'free_asso.cause_sickness.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseSickness',
