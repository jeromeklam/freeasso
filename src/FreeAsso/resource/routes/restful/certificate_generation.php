...
/**
 * Routes for CertificateGeneration
 *
 * @author jeromeklam
 */
$certificateGenerationRoutes = [
    'free_asso.certificate_generation.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CertificateGeneration',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CertificateGeneration',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate_generation/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CertificateGeneration',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::CertificateGeneration',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.certificate_generation.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CertificateGeneration',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CertificateGeneration',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate_generation',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CertificateGeneration',
    ...
    'free_asso.certificate_generation.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CertificateGeneration',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CertificateGeneration',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate_generation/:cerg_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CertificateGeneration',
    ...
    'free_asso.certificate_generation.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CertificateGeneration',
    ...
    'free_asso.certificate_generation.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CertificateGeneration',
    ...
    'free_asso.certificate_generation.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CertificateGeneration',
