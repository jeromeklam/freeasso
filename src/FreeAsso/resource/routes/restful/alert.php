 ...
 */
$alertRoutes = [
    'free_asso.alert.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Alert',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Alert',
        FFCSTRT::ROUTE_URL        => '/v1/asso/alert/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Alert',
    ...
    'free_asso.alert.getall' => [
        ...
        FFCSTRT::ROUTE_MIDDLEWARE => [],
        FFCSTRT::ROUTE_INCLUDE    => [
            FFCSTRT::ROUTE_INCLUDE_DEFAULT => ['cause', 'site', 'client']
        ],
        FFCSTRT::ROUTE_SCOPE      => [],
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
    ...
    'free_asso.alert.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Alert',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Alert',
        FFCSTRT::ROUTE_URL        => '/v1/asso/alert/:alert_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Alert',
