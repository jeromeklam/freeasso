 ...
 */
$statisticRoutes = [
    'free_asso.statistic.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Statistic',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Statistic',
        FFCSTRT::ROUTE_URL        => '/v1/asso/statistic/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Statistic',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::Statistic',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.statistic.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Statistic',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Statistic',
        FFCSTRT::ROUTE_URL        => '/v1/asso/statistic',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Statistic',
    ...
    'free_asso.statistic.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Statistic',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Statistic',
        FFCSTRT::ROUTE_URL        => '/v1/asso/statistic/:stat_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Statistic',
