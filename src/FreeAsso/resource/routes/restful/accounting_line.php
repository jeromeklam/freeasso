...
/**
 * Routes for AccountingLine
 *
 * @author jeromeklam
 */
$accountingLine = [
    'free_asso.accounting_line.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/AccountingLine',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::AccountingLine',
        FFCSTRT::ROUTE_URL        => '/v1/asso/accounting_line/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::AccountingLine',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::AccountingLine',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.accounting_line.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/AccountingLine',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::AccountingLine',
        FFCSTRT::ROUTE_URL        => '/v1/asso/accounting_line',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::AccountingLine',
    ...
    'free_asso.accounting_line.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/AccountingLine',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::AccountingLine',
        FFCSTRT::ROUTE_URL        => '/v1/asso/accounting_line/:accl_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::AccountingLine',
    ...
    'free_asso.accounting_line.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/AccountingLine',
    ...
    'free_asso.accounting_line.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/AccountingLine',
    ...
    'free_asso.accounting_line.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/AccountingLine',
