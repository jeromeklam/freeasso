...
/**
 * Routes for CauseMainType
 *
 * @author jeromeklam
 */
$causeMainTypeRoutes = [
    'free_asso.cause_main_type.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseMainType',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseMainType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_main_type/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseMainType',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::CauseMainType',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.cause_main_type.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseMainType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseMainType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_main_type',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseMainType',
    ...
    'free_asso.cause_main_type.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseMainType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseMainType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_main_type/:camt_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseMainType',
    ...
    'free_asso.cause_main_type.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseMainType',
    ...
    'free_asso.cause_main_type.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseMainType',
    ...
    'free_asso.cause_main_type.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseMainType',
