...
/**
 * Routes for CauseGrowth
 *
 * @author jeromeklam
 */
$causeGrowthRoutes = [
    'free_asso.cause_growth.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseGrowth',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseGrowth',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_growth/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseGrowth',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::CauseGrowth',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.cause_growth.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseGrowth',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseGrowth',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_growth',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseGrowth',
        ...
        FFCSTRT::ROUTE_MIDDLEWARE => [],
        FFCSTRT::ROUTE_INCLUDE    => [
            FFCSTRT::ROUTE_INCLUDE_DEFAULT => ['cause']
        ],
        FFCSTRT::ROUTE_SCOPE      => [],
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
    ...
    'free_asso.cause_growth.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseGrowth',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::CauseGrowth',
        FFCSTRT::ROUTE_URL        => '/v1/asso/cause_growth/:grow_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::CauseGrowth',
    ...
    'free_asso.cause_growth.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseGrowth',
    ...
    'free_asso.cause_growth.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseGrowth',
    ...
    'free_asso.cause_growth.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/CauseGrowth',
