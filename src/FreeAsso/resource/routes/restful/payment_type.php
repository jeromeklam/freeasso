...
/**
 * Routes for PaymentType
 *
 * @author jeromeklam
 */
$paymentTypeRoutes = [
    'free_asso.payment_type.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/PaymentType',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::PaymentType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/payment_type/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::PaymentType',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::PaymentType',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.payment_type.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/PaymentType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::PaymentType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/payment_type',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::PaymentType',
    ...
    'free_asso.payment_type.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/PaymentType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::PaymentType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/payment_type/:ptyp_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::PaymentType',
    ...
    'free_asso.payment_type.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/PaymentType',
    ...
    'free_asso.payment_type.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/PaymentType',
    ...
    'free_asso.payment_type.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/PaymentType',
