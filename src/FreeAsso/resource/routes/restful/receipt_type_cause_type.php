...
/**
 * Routes for ReceiptTypeCauseType
 *
 * @author jeromeklam
 */
$routes_receipt_type_cause_type = [
    'free_asso.receipt_type_cause_type.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptTypeCauseType',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ReceiptTypeCauseType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/receipt_type_cause_type/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ReceiptTypeCauseType',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::ReceiptTypeCauseType',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.receipt_type_cause_type.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptTypeCauseType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ReceiptTypeCauseType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/receipt_type_cause_type',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ReceiptTypeCauseType',
    ...
    'free_asso.receipt_type_cause_type.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptTypeCauseType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ReceiptTypeCauseType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/receipt_type_cause_type/:rtct_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ReceiptTypeCauseType',
    ...
    'free_asso.receipt_type_cause_type.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptTypeCauseType',
    ...
    'free_asso.receipt_type_cause_type.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptTypeCauseType',
    ...
    'free_asso.receipt_type_cause_type.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptTypeCauseType',
