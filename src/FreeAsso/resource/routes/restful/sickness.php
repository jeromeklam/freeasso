 ...
 */
$sicknessRoutes = [
    'free_asso.sickness.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Sickness',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Sickness',
        FFCSTRT::ROUTE_URL        => '/v1/asso/sickness/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Sickness',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::Sickness',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.sickness.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Sickness',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Sickness',
        FFCSTRT::ROUTE_URL        => '/v1/asso/sickness',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Sickness',
    ...
    'free_asso.sickness.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Sickness',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Sickness',
        FFCSTRT::ROUTE_URL        => '/v1/asso/sickness/:sick_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Sickness',
