 ...
 */
$familyRoutes = [
    'free_asso.family.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Family',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Family',
        FFCSTRT::ROUTE_URL        => '/v1/asso/family/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Family',
    ...
    'free_asso.family.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Family',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Family',
        FFCSTRT::ROUTE_URL        => '/v1/asso/family/:fam_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Family',
