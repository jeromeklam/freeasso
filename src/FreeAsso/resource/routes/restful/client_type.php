...
/**
 * Routes for ClientType
 *
 * @author jeromeklam
 */
$clientTypeRoutes = [
    'free_asso.client_type.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientType',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ClientType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/client_type/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ClientType',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::ClientType',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.client_type.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ClientType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/client_type',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ClientType',
    ...
    'free_asso.client_type.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ClientType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/client_type/:clit_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ClientType',
    ...
    'free_asso.client_type.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientType',
    ...
    'free_asso.client_type.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientType',
    ...
    'free_asso.client_type.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientType',
