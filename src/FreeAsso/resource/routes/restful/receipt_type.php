...
/**
 * Routes for ReceiptType
 *
 * @author jeromeklam
 */
$receiptTypeRoutes = [
    'free_asso.receipt_type.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptType',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ReceiptType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/receipt_type/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ReceiptType',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::ReceiptType',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.receipt_type.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ReceiptType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/receipt_type',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ReceiptType',
    ...
    'free_asso.receipt_type.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ReceiptType',
        FFCSTRT::ROUTE_URL        => '/v1/asso/receipt_type/:rett_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ReceiptType',
    ...
    'free_asso.receipt_type.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptType',
    ...
    'free_asso.receipt_type.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptType',
    ...
    'free_asso.receipt_type.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ReceiptType',
