...
/**
 * Routes for ClientCategory
 *
 * @author jeromeklam
 */
$clientCategoryRoutes = [
    'free_asso.client_category.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientCategory',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ClientCategory',
        FFCSTRT::ROUTE_URL        => '/v1/asso/client_category/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ClientCategory',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::ClientCategory',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.client_category.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientCategory',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ClientCategory',
        FFCSTRT::ROUTE_URL        => '/v1/asso/client_category',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ClientCategory',
    ...
    'free_asso.client_category.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientCategory',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::ClientCategory',
        FFCSTRT::ROUTE_URL        => '/v1/asso/client_category/:clic_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::ClientCategory',
    ...
    'free_asso.client_category.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientCategory',
    ...
    'free_asso.client_category.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientCategory',
    ...
    'free_asso.client_category.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/ClientCategory',
