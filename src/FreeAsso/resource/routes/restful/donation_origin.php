...
/**
 * Routes for DonationOrigin
 *
 * @author jeromeklam
 */
$donationOriginRoutes = [
    'free_asso.donation_origin.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/DonationOrigin',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::DonationOrigin',
        FFCSTRT::ROUTE_URL        => '/v1/asso/donation_origin/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::DonationOrigin',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeAsso::Model::DonationOrigin',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_asso.donation_origin.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/DonationOrigin',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::DonationOrigin',
        FFCSTRT::ROUTE_URL        => '/v1/asso/donation_origin',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::DonationOrigin',
    ...
    'free_asso.donation_origin.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/DonationOrigin',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::DonationOrigin',
        FFCSTRT::ROUTE_URL        => '/v1/asso/donation_origin/:dono_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::DonationOrigin',
    ...
    'free_asso.donation_origin.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/DonationOrigin',
    ...
    'free_asso.donation_origin.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/DonationOrigin',
    ...
    'free_asso.donation_origin.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/DonationOrigin',
