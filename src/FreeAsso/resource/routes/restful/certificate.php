 ...
 */
$certificateRoutes = [
    'free_asso.certificate.autocomplete' => [
        ...
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate/autocomplete/:search',
    ...
    'free_asso.certificate.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Certificate',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Certificate',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Certificate',
    ...
    'free_asso.certificate.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Certificate',
    ...
    'free_asso.certificate.sendone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Certificate',
        FFCSTRT::ROUTE_COMMENT    => 'Re envoi un objet',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_POST,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Certificate',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate/send/:cert_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Certificate',
    ...
    'free_asso.certificate.generateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Certificate',
        FFCSTRT::ROUTE_COMMENT    => 'Re génère un objet',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_PUT,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Certificate',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate/generate/:cert_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Certificate',
    ...
    'free_asso.certificate.downloadone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeAsso/Asso/Certificate',
        FFCSTRT::ROUTE_COMMENT    => 'Télécharge le certificat',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_POST,
        FFCSTRT::ROUTE_MODEL      => 'FreeAsso::Model::Certificate',
        FFCSTRT::ROUTE_URL        => '/v1/asso/certificate/download/:cert_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeAsso::Controller::Certificate',
